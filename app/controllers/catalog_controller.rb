...
class CatalogController < ApplicationController  
  ...
  configure_blacklight do |config|
    ...
    config.show.html_title = 'filename_display'
    config.show.heading = 'filename_full_display'
    config.show.display_type = 'libmagic_display'
    ...
    #   The ordering of the field names is the order of the display 
    config.add_index_field 'filename_display', :label => 'Filename' 
    config.add_index_field 'path_s', :label => 'Full Path' 
    config.add_index_field 'volume_display', :label => 'Image File' 
    config.add_index_field 'name_type_s', :label => 'Type' 
    ...
    #   The ordering of the field names is the order of the display 
    config.add_show_field 'filename_display', :label => 'Filename' 
    config.add_show_field 'path_s', :label => 'Full Path' 
    config.add_show_field 'volume_display', :label => 'Image File' 
    config.add_show_field 'name_type_s', :label => 'Type' 
    ...
    config.add_sort_field 'filename_sort asc', :label => 'path'
    config.add_sort_field 'inode_i asc', :label => 'inode'
    config.add_sort_field 'atime_dt desc', :label => 'access time'
    config.add_sort_field 'ctime_dt desc', :label => 'change time'
    config.add_sort_field 'crtime_dt desc', :label => 'creation time'
    config.add_sort_field 'dtime_dt desc', :label => 'access time'
    config.add_sort_field 'filesize_i desc', :label => 'size'
